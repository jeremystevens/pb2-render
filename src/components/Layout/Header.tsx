          ...
          <div className="flex items-center space-x-4">
            ...
            {isAuthenticated ? (
              ...
              <div className="flex items-center space-x-3">
                <Link
                  to="/login"
                  className="px-3 py-1.5 text-sm font-medium border border-indigo-500 text-indigo-600 dark:border-indigo-400 dark:text-indigo-400 rounded-md hover:bg-indigo-50 dark:hover:bg-slate-800 transition-colors"
                >
                  Login
                </Link>
                <Link
